...
ColorSelector.prototype =
{
	...
	init: function(gradient)
	{
		...
		this.container.id = 'selectordecolor';
		...
		function onMouseDown( event )
		{
			...
			update( event.clientX+2-document.getElementById("armonia").offsetLeft-((document.getElementById("canvas").offsetWidth - document.getElementById("canvas").style.width.slice(0,-2))/2)+document.body.scrollLeft - scope.container.offsetLeft, event.clientY - scope.container.offsetTop );
		}
		...
		function onTouchStart( event )
		{
			if(event.touches.length == 1)
			{
				...
				update( event.touches[0].pageX+2-document.getElementById("armonia").offsetLeft-((document.getElementById("canvas").offsetWidth - document.getElementById("canvas").style.width.slice(0,-2))/2)+document.body.scrollLeft - scope.container.offsetLeft, event.touches[0].pageY - scope.container.offsetTop );
			}
		}
